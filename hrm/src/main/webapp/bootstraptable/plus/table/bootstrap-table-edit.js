...
(function($){
    ...
    BootstrapTable.prototype.submitRow = function(rowNum){
    	var data = this.options.data[rowNum];
    	/*console.info(data["+granttime+"]);*/
    	$.post("/hrm/stipend/saveStipend", data,
    	 function(data){
    	         alert("已保存！ccc");
    ...
    BootstrapTable.prototype.removeRow = function (rowNum) {
        ...
        //删除数据
        var data = that.options.data[rowNum];
    	console.info(JSON.stringify(data));
    	$.post("/hrm/stipend/getDeleteStipend", data,
    	 function(data){
    	         alert("已刪除");
    	 });
    ...
    $.fn.bootstrapTable.methods.push('getColumns',
        'getModiDatas','removeRow','getColTotal','submitRow');
